defmodule Rumbl.VideoControllerTest do
  ...
  @tag login_as: "max"
  test "creates uer video and redirects", %{conn: conn, user: user} do
  ...
  @tag login_as: "max"
  test "lists all suer's videos on index", %{conn: conn, user: user} do
    user_video = insert_video(user, title: "funny cats")
    other_video = insert_video(insert_user(username: "other"), title: "antoher video")
  ...
  test "requires user autherntication on all actions", %{conn: conn} do
    Enum.each([
